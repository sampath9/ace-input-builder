...
<%@ page import="uiCommon.BeanClass"%>
...
<body bgcolor="#FCFAE8">
	...
	<form name="MetaDataPage" id="MetaDataPage" method="post" onsubmit="fnGetValues();">
			...
			<tr>
				<td>
					<ul id="navigation">
						...
						<li class="dropdown"><a href="ManagementEvents.jsp">Management
								Events</a> <!-- <ul class="sub_navigation">
								<li><a href="#">Sub Navigation 1</a></li>
								<li><a href="#">Sub Navigation 2</a></li>
								<li><a href="#">Sub Navigation 3</a></li>
							</ul> --></li>
				...
				<td>
					<table cellpadding="20">
						<tr>
							...
							<select name="codeDisplay" id="codeDisplay" style="border-color: #FFD175;" onchange="fnCheckSelected();">
									<%for (int i=0; i<=CountMetaData-1; i++){%>
									<option id="codeOptionId"
										value="<%= MetadataValues[i][0] %>" ><%= MetadataValues[i][0] %></option>
									<%}
						     	%>
							</select></td>
							<td>Description <select name="Description" id="Description" style="border-color: #FFD175;">
									<%for (int i=0; i<=CountMetaData-1; i++){%>
									<option value="<%= MetadataValues[i][1] %>"><%= MetadataValues[i][1] %></option>
									<%}%>
							</select></td>
							<td>Unit or Type <select name="unit_or_type" id="unit_or_type" style="border-color: #FFD175;">
									<%for (int i=0; i<=CountMetaData-1; i++){%>
									<option value="<%= MetadataValues[i][2] %>"><%= MetadataValues[i][2] %></option>
									<% } %>
							</select></td>
							<td>Enter the Value<input type="text" style="height:23px; border-color:  " name="userInput" id="userInput"></td>
						</tr>
					</table>
				</td>
			</tr>
